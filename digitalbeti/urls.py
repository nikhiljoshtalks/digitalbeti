...
urlpatterns = [
    ...
    path('state-webinar', views.state_webinar, name='state-webinar'),
    path('state-event', views.state_event, name='state-event'),
    ...
    path('user/download-certificate/<str:ref_hash>',
         views.UserCertificateView.as_view(), name='user_download_certificate'),
    path('user/download-certificate/<str:ref_hash>',
    ...
    path('vle/download-certificate/<str:ref_hash>',
         views.VLECertificateView.as_view(), name='vle_download_certificate'),
    ...
    path('su/all-vles',views.all_vles, name='admin_all_vles'),
    path('su/delete-vle/<str:email>',views.delete_vle, name='admin_delete_vle'),
]
